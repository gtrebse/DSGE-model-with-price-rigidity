...
M_.param_names = char(M_.param_names, 'rhoinert');
M_.param_names_tex = char(M_.param_names_tex, 'rhoinert');
M_.param_names_long = char(M_.param_names_long, 'rhoinert');
...
erase_compiled_function('AAAmodel_static');
erase_compiled_function('AAAmodel_dynamic');
M_.orig_eq_nbr = 15;
M_.eq_nbr = 15;
M_.ramsey_eq_nbr = 0;
...
M_.params( 16 ) = 0.25;
G = M_.params( 16 );
M_.params( 19 ) = M_.params(1)*(1-M_.params(1))*(1-M_.params(1)*M_.params(2))/(1+M_.params(1)*M_.params(2))*(M_.params(11)+M_.params(10)*M_.params(14)/M_.params(15));
kappa = M_.params( 19 );
M_.params( 17 ) = 1.5;
phi_pi = M_.params( 17 );
M_.params( 18 ) = 0.5;
...
save('AAAmodel_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('AAAmodel_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('AAAmodel_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('AAAmodel_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('AAAmodel_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('AAAmodel_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('AAAmodel_results.mat', 'oo_recursive_', '-append');
end
