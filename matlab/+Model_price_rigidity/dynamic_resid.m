...
if T_flag
    T = Model_price_rigidity.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(16, 1);
lhs = y(7);
...
residual(8) = lhs - rhs;
lhs = y(17);
rhs = y(9)+y(7)*(params(8)+params(7)*params(1)/params(2))-y(11)*(1+params(8))+y(18)*params(7)*params(3)/params(2)-y(19);
residual(9) = lhs - rhs;
lhs = y(20);
