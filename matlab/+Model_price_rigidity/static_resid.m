...
if T_flag
    T = Model_price_rigidity.static_resid_tt(T, y, x, params);
end
residual = zeros(16, 1);
lhs = y(1);
...
residual(8) = lhs - rhs;
lhs = y(11);
rhs = y(3)+y(1)*(params(8)+params(7)*params(1)/params(2))-y(5)*(1+params(8))+y(12)*params(7)*params(3)/params(2)-y(13);
residual(9) = lhs - rhs;
lhs = y(14);
