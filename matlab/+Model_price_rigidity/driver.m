...
diary off;
diary('Model_price_rigidity.log');
...
M_.params(15) = 0.8;
phi_x = M_.params(15);
M_.params(16) = (1-M_.params(5))*(1-M_.params(5)*M_.params(4))/(M_.params(5)*M_.params(6))*(M_.params(8)+M_.params(7)*M_.params(1)/M_.params(2));
kappa = M_.params(16);
%
% SHOCKS instructions
%
...
save('Model_price_rigidity_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Model_price_rigidity_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Model_price_rigidity_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Model_price_rigidity_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Model_price_rigidity_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('Model_price_rigidity_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('Model_price_rigidity_results.mat', 'oo_recursive_', '-append');
end
