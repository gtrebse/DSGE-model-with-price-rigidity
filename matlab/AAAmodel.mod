...
parameters theta beta rhoa rhog rhochi rhomp sigmaa sigmag sigmachi gamma gamma_n lambda rhoinert Y C G phi_pi phi_x kappa;
...
// Taylor Rule 1
i = rhoinert*i(-1) + phi_pi*pi + phi_x*x + amp;
